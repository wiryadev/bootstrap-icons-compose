...
public val NormalGroup.ReplyAll: ImageVector
    get() {
        if (_replyAll != null) {
            return _replyAll!!
        }
        _replyAll = Builder(name = "ReplyAll", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.502f, 0.502f, 0.0f, false, false, -0.042f, -0.028f)
                arcToRelative(0.147f, 0.147f, 0.0f, false, true, 0.0f, -0.252f)
                arcToRelative(0.497f, 0.497f, 0.0f, false, false, 0.042f, -0.028f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.147f, 0.147f, 0.0f, false, true, 0.0f, -0.252f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, 0.042f, -0.028f)
