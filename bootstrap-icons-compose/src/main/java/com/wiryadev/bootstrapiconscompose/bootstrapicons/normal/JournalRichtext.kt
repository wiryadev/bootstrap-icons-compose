...
public val NormalGroup.JournalRichtext: ImageVector
    get() {
        if (_journalRichtext != null) {
            return _journalRichtext!!
        }
        _journalRichtext = Builder(name = "JournalRichtext", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.639f, 5.292f)
                lineTo(7.969f, 6.178f)
                lineTo(9.823f, 4.323f)
