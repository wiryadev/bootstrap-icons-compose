...
public val FilledGroup.PiggyBank: ImageVector
    get() {
        if (_piggyBank != null) {
            return _piggyBank!!
        }
        _piggyBank = Builder(name = "PiggyBank", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.138f, 4.753f)
                arcTo(6.613f, 6.613f, 0.0f, false, true, 7.964f, 4.5f)
                curveToRelative(0.666f, 0.0f, 1.303f, 0.097f, 1.893f, 0.273f)
                arcToRelative(0.5f, 0.5f, 0.0f, true, false, 0.286f, -0.958f)
                arcTo(7.601f, 7.601f, 0.0f, false, false, 7.964f, 3.5f)
