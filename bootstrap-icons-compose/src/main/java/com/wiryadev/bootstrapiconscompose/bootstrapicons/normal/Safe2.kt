...
public val NormalGroup.Safe2: ImageVector
    get() {
        if (_safe2 != null) {
            return _safe2!!
        }
        _safe2 = Builder(name = "Safe2", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(3.482f, 3.482f, 0.0f, false, false, 5.035f, 8.0f)
                close()
                moveTo(6.404f, 5.697f)
                lineTo(7.484f, 6.777f)
                curveToRelative(0.16f, -0.094f, 0.332f, -0.167f, 0.516f, -0.214f)
                lineTo(8.0f, 5.035f)
                arcToRelative(3.482f, 3.482f, 0.0f, false, false, -1.596f, 0.662f)
                close()
                moveTo(9.0f, 5.035f)
                verticalLineToRelative(1.528f)
                curveToRelative(0.184f, 0.047f, 0.357f, 0.12f, 0.516f, 0.214f)
                lineToRelative(1.08f, -1.08f)
                arcTo(3.482f, 3.482f, 0.0f, false, false, 9.0f, 5.035f)
                close()
                moveTo(11.303f, 6.404f)
                lineTo(10.223f, 7.484f)
                curveToRelative(0.094f, 0.16f, 0.167f, 0.332f, 0.214f, 0.516f)
                horizontalLineToRelative(1.528f)
                arcToRelative(3.483f, 3.483f, 0.0f, false, false, -0.662f, -1.596f)
                close()
                moveTo(11.965f, 9.0f)
                horizontalLineToRelative(-1.528f)
                curveToRelative(-0.047f, 0.184f, -0.12f, 0.357f, -0.214f, 0.516f)
                lineToRelative(1.08f, 1.08f)
                arcTo(3.483f, 3.483f, 0.0f, false, false, 11.965f, 9.0f)
                close()
                moveTo(10.596f, 11.303f)
                lineTo(9.516f, 10.223f)
                curveToRelative(-0.16f, 0.094f, -0.332f, 0.167f, -0.516f, 0.214f)
                verticalLineToRelative(1.528f)
                arcToRelative(3.483f, 3.483f, 0.0f, false, false, 1.596f, -0.662f)
                close()
                moveTo(8.0f, 11.965f)
                verticalLineToRelative(-1.528f)
                arcToRelative(1.989f, 1.989f, 0.0f, false, true, -0.516f, -0.214f)
                lineToRelative(-1.08f, 1.08f)
                arcTo(3.483f, 3.483f, 0.0f, false, false, 8.0f, 11.965f)
                close()
                moveTo(5.697f, 10.596f)
                lineTo(6.777f, 9.516f)
                arcTo(1.988f, 1.988f, 0.0f, false, true, 6.563f, 9.0f)
                lineTo(5.035f, 9.0f)
