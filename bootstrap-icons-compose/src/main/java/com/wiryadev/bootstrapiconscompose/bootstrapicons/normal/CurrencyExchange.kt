...
public val NormalGroup.CurrencyExchange: ImageVector
    get() {
        ...
        _currencyExchange = Builder(name = "CurrencyExchange", defaultWidth = 16.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(0.0f, 5.0f)
                arcToRelative(5.002f, 5.002f, 0.0f, false, false, 4.027f, 4.905f)
                arcToRelative(6.46f, 6.46f, 0.0f, false, true, 0.544f, -2.073f)
                curveTo(3.695f, 7.536f, 3.132f, 6.864f, 3.0f, 5.91f)
                horizontalLineToRelative(-0.5f)
                verticalLineToRelative(-0.426f)
                horizontalLineToRelative(0.466f)
                lineTo(2.966f, 5.05f)
                curveToRelative(0.0f, -0.046f, 0.0f, -0.093f, 0.004f, -0.135f)
                lineTo(2.5f, 4.915f)
                ...
                arcToRelative(3.46f, 3.46f, 0.0f, false, false, -0.815f, -0.082f)
                curveToRelative(-0.919f, 0.0f, -1.538f, 0.466f, -1.734f, 1.252f)
                horizontalLineToRelative(1.917f)
                verticalLineToRelative(0.427f)
                horizontalLineToRelative(-1.98f)
                curveToRelative(-0.003f, 0.046f, -0.003f, 0.097f, -0.003f, 0.147f)
