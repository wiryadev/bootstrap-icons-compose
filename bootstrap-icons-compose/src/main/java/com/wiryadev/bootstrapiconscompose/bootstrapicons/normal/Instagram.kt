...
public val NormalGroup.Instagram: ImageVector
    get() {
        if (_instagram != null) {
            return _instagram!!
        }
        _instagram = Builder(name = "Instagram", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(3.917f, 3.917f, 0.0f, false, false, -1.417f, 0.923f)
                arcTo(3.927f, 3.927f, 0.0f, false, false, 0.42f, 2.76f)
                ...
                arcToRelative(3.916f, 3.916f, 0.0f, false, false, 1.416f, -0.923f)
                ...
                arcToRelative(3.926f, 3.926f, 0.0f, false, false, -0.923f, -1.417f)
                arcTo(3.911f, 3.911f, 0.0f, false, false, 13.24f, 0.42f)
                ...
                curveToRelative(0.28f, 0.28f, 0.453f, 0.546f, 0.598f, 0.92f)
                ...
                arcToRelative(2.47f, 2.47f, 0.0f, false, true, -0.599f, 0.919f)
                ...
                arcToRelative(2.478f, 2.478f, 0.0f, false, true, -0.92f, -0.598f)
                arcToRelative(2.48f, 2.48f, 0.0f, false, true, -0.6f, -0.92f)
                curveToRelative(-0.109f, -0.281f, -0.24f, -0.705f, -0.275f, -1.485f)
                curveToRelative(-0.038f, -0.843f, -0.046f, -1.096f, -0.046f, -3.233f)
                curveToRelative(0.0f, -2.136f, 0.008f, -2.388f, 0.046f, -3.231f)
